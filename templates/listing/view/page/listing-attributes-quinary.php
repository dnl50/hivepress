...
if (hp\is_field_specified($listing, 'view_page_quinary')) : ?>
    <div class="hp-listing__attributes hp-listing__attributes--quinary">
        <div class="hp-row">
            <?php
            foreach ($listing->_get_fields('view_page_quinary') as $field) :
